...
<?php
	...
	echo $this->Html->script('gauge.js/dist/gauge.min');
	echo $this->Html->script('bootstrap-progressbar/bootstrap-progressbar.min');
	echo $this->Html->script('iCheck/icheck.min');
	echo $this->Html->script('skycons/skycons');
	...
	echo $this->Html->script('DateJS/build/date');
	echo $this->Html->script('jqvmap/dist/jquery.vmap');
	echo $this->Html->script('jqvmap/dist/maps/jquery.vmap.world');
	echo $this->Html->script('jqvmap/examples/js/jquery.vmap.sampledata');
